function CryptoCard({ name, price, symbol, priceChange, currency, isFavorite, onToggleFavorite }) {
  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-md w-48 relative flex flex-col">
      ...
      >
        <span className={isFavorite ? "text-amber-400 hover:text-amber-500" : "text-gray-400 hover:text-gray-500"}>
          {isFavorite ? '★' : '☆'}
        </span>
      </button>
      <div className="flex flex-col items-center justify-center flex-grow text-center pt-5">
